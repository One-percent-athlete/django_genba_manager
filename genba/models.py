...
class Genba(models.Model):
    ...
    color = models.CharField("色", max_length=30, choices=COLORS)
    ...
    finished = models.BooleanField("作業終了", default=False)
    date_created = models.DateTimeField("現場作成日", auto_now_add=True)
...
class DailyReport(models.Model):
    ...
    other_payment_amount = models.CharField("その他料金", max_length=100, blank=True)
